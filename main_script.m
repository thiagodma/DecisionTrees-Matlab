...
[actCost_qp22, optimCost_qp22, accuracy_qp22] = transc_qp22.predictionsCostAndAccuracy(transc_qp22.data);
...
%evaluates the performance of the classifier
[actCost_qp27, optimCost_qp27, accuracy_qp27] = transc_qp27.predictionsCostAndAccuracy(transc_qp27.data);
...
%evaluates the performance of the classifier
[actCost_qp32, optimCost_qp32, accuracy_qp32] = transc_qp32.predictionsCostAndAccuracy(transc_qp32.data);
...
%evaluates the performance of the classifier
[actCost_qp37, optimCost_qp37, accuracy_qp37] = transc_qp37.predictionsCostAndAccuracy(transc_qp37.data);
